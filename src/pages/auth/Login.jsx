...
const Login = ({ onNavigate }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (res.success) {
            // Navigation handled by App.jsx based on auth state, but we can trigger a re-render or just wait
        } else {
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-slate-100">
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 mt-2">Sign in to continue to Civic Trust</p>
                </div>
